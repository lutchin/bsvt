    ...
    <div class="container add_form_step1">
        ...
        <form action="/analyst/various/add1" method="post">
            ...
            <div class="row name_report">
                ...
                <span>
		        	<input name="number" value="" placeholder="Введите название" style="width: 550px !important"/>
		        </span>
            </div>
            <div class="row justify-content-center">
