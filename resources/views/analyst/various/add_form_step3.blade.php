...
@section('content')
    ...
    <div class="container page_create_post">
        ...
        <form id="form" action="/analyst/various/add3" method="post" enctype="multipart/form-data">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-12 box_info">
                    <p class="d-flex justify-content-start">
                        <span class="name">Отчет: </span><span class="text">{{ $variousreport->number }} <!--за период от {{ date("d.m.Y",$variousreport->start_date)}} до {{ date("d.m.Y",$variousreport->end_date)}}--></span>
                    </p>
                    {{--@if($variouscategory instanceof \App\models\analyst\various\Variouscategory)--}}
                    {{--<p class="d-flex justify-content-start">--}}
                        {{--<span class="name">Раздел: </span><span class="text">{{ $variouscategory->title }}</span>--}}
                        {{--<input type="text" hidden name="variouscategory" value="{{ $variouscategory->id }}">--}}
                    {{--</p>--}}
                    {{--@endif--}}
                    {{--@if($varioussubcategory instanceof \App\models\analyst\various\Varioussubcategory)--}}
                    {{--<p class="d-flex justify-content-start">--}}
                        {{--<span class="name">Подраздел: </span><span class="text">{{ $varioussubcategory->title }}</span>--}}
                    {{--</p>--}}
                        {{--<input type="text" hidden name="varioussubcategory" value="{{ $varioussubcategory->id }}">--}}
                    {{--@endif--}}
            ...
            <div class="row box_save_article mt30">
              ...
              <button onclick="jQuery('#form').attr('action','/analyst/various/add3/1'); jQuery('#form').submit(); return false;" class="button_save butt butt_def">Сохранить и отправить на утверждение</button>
            ...
            <div class="row name_report name_report_step3 d-flex justify-content-center">
	            ...
	            <div class="col-md-4 float_left d-flex  flex-column justify-content-center align-items-start box_left">
		            ...
		            <span class="select_wrap calendar_wrap" style="display: none;">
			        	...
			        	<input type="hidden" value="<?php echo $variousreport->start_date; ?>" name="start_period">
		        	</span>
		        </div>
		        ...
		        <div class="col-md-4 float_left d-flex  flex-column justify-content-center align-items-start box_right">
		                ...
		                <span class="select_wrap calendar_wrap" style="display: none;">
				        	...
				        	<input type="hidden" value="<?php echo $variousreport->end_date; ?>" name="end_period">
				        </span>
			    </div>	
    ...
    <script type="text/javascript" charset="utf-8">
       jQuery(document).ready(function () {
            jQuery('.calendar_start_3').datepicker({
                ...
                value: '<?php echo date("d.m.Y",$variousreport->start_date); ?>',
                format: 'dd.mm.yyyy',
            });
            ...
            jQuery('.calendar_end_3').datepicker({
                ...
                minDate: '<?php echo date("d.m.Y",$variousreport->start_date); ?>',
                maxDate: '<?php echo date("d.m.Y",$variousreport->end_date); ?>',
                value: '<?php echo date("d.m.Y",$variousreport->end_date); ?>',
                format: 'dd.mm.yyyy',
